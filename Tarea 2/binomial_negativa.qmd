...
ggplot(data_comp, aes(x = k, y = Probabilidad, fill = Tipo)) +
  ...
  scale_fill_manual(values = c("Teórica" = "pink", "Simulada" = "steelblue")) 
```
...
ggplot(data_conv) +
  geom_line(aes(x = n, y = Media_simulada), color = "darkorange", linewidth = 1) +
  geom_hline(yintercept = media_teorica, color = "darkgreen", 
...
ggplot(data_tcl, aes(x = valores_norm)) +
  geom_histogram(aes(y = after_stat(density)), alpha = 0.6, bins = 30, fill = "pink") +
...
ggplot(data.frame(iteraciones = iteraciones_fallidas), aes(x = iteraciones)) +
  ...
  geom_vline(xintercept = media_iteraciones, color = "darkblue", 
...
ggplot(data.frame(fallados = simulacion_baloncesto), aes(x = fallados)) +
  ...
  geom_vline(xintercept = esperado_fallados, color = "darkblue", 
             linetype = "dashed", linewidth = 1) +
...
ggplot(data.frame(fallidas = simulacion_lab), aes(x = fallidas)) +
  ...
  geom_vline(xintercept = esperado_fallidas_lab, color = "darkgreen", 
             linetype = "dashed", linewidth = 1) +
